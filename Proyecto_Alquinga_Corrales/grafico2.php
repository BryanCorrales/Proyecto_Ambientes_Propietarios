<?php 
	...
	$query='SELECT count(TIPOCASA) Numero, Provincia FROM `datos` where Region="Costa" and TIPOCASA="rancho" GROUP by Provincia';
	...
	<head>
		...
		<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"> </script>
           ...
           {  
                ...
                var options = {  
                      title: 'Total de casas de tipo Rancho que existen en la region Costa',  
                      //is3D:true,  
                      //pieHole: 0.4  
                     };  
